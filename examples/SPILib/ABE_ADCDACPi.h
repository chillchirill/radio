...
ADCDACPi(const char* adcDev = "/dev/spidev0.0",
             const char* dacDev = "/dev/spidev0.1");
...
const char* adc_device; // spidev ADC name, e.g. "/dev/spidev0.0"
const char* dac_device; // spidev DAC name, e.g. "/dev/spidev0.1"
